...
WII_CONTROL_REPLACER = {
  ...
  re.compile(r"\[6:([0-9a-f]{2})([0-9a-f]{2})00000000([0-9a-f]{2})([0-9a-f]{2})([0-9a-f]{2})([0-9a-f]{2})\]"): r"[placeholder6:\1\2,\3\4\5\6]",
  re.compile(r"\[7:([0-9a-f]{2})([0-9a-f]{2})00000000([0-9a-f]{2})([0-9a-f]{2})([0-9a-f]{2})([0-9a-f]{2})\]"): r"[placeholder7:\1\2,\3\4\5\6]",
...
NSW_CONTROL_REPLACER = {
  ...
  re.compile(r"\[5:0000([0-9a-f]{2})00\]"): r"[unk5:\1]",
  re.compile(r"\[6:([0-9a-f]{2})([0-9a-f]{2})00000000([0-9a-f]{2})([0-9a-f]{2})([0-9a-f]{2})([0-9a-f]{2})\]"): r"[placeholder6:\2\1,\6\5\4\3]",
  re.compile(r"\[7:([0-9a-f]{2})([0-9a-f]{2})00000000([0-9a-f]{2})([0-9a-f]{2})([0-9a-f]{2})([0-9a-f]{2})\]"): r"[placeholder7:\2\1,\6\5\4\3]",
